...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                다른 화면을 보이고자 할때는
                Intent 만들고 startActivity() method를 사용하여 intent를 열어준다.
                 */
                //새로운 창을 열어 값을 입력받고 입력받은 값을 다시 되돌려 받기위한 코드
               // Intent intent=new Intent(MainActivity.this,InputActivity.class);
                //startActivity(intent);
                //reqcode: 열리는 activity와 열린 activity가 서로 데이터를 교환할때 사용할 ID 값
               // startActivityForResult(intent, RequestCode.REQUEST_INPUT_CODE);

                //폰에 저장된 이미지를 불러와서
                //content.xml의 imageview에 표시를 하려고 한다

                //폰에 저장된 이미지 정보를 보기위한 시스템 내장 intent를 호출하기
                ...
                //이미지를 저장하는 공간
                //내장메모리 외장 sd 모두 나에게 접근할수 있게 해달라.
                imgIntent.setData(MediaStore.Images.Media.EXTERNAL_CONTENT_URI);

                //이미지 보기 열렸을때 이미지를 클릭하면 해당 이미지 정보를 return 받기 위해서
                //intent 열기
    ...
    //현재 activity에서 새로운 activity를 열었을때 새로운 activity가 어떤 ㄱ값을 되돌려주면
    //그 값을 수신할 method
    @Override
