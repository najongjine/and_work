...
import com.biz.myapp.com.biz.myapp.utils.MyViewClass;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    이벤트를 처리해야할 view(compo)들이 있는데 댇체로 이벤트 처리 코드가 유사한 경우
    한번만 이벤트 러치 코드를 작성하고 view들이 공유해서 사용하기 위함이다.
